      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-8 mt-12 max-w-xl md:max-w-2xl mx-auto">
        {pricingTiers.map((tier, i) => (
          ...
          >
            ...
            <h3 className="text-3xl font-semibold text-slate-900 dark:text-white">{tier.name}</h3>
            <div className="mt-4 flex items-baseline text-2xl">
            ...
            <p className="mt-4 text-slate-500 dark:text-slate-400 text-xl">{tier.description}</p>
